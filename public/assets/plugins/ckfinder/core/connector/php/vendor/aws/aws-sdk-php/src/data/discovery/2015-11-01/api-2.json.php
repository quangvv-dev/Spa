...
return [
    ...
    'shapes' => [
        ...
        'AgentId' => ['type' => 'string',],
        'AgentIds' => ['type' => 'list', 'member' => ['shape' => 'AgentId',],],
        'AgentInfo' => [
            'type' => 'structure',
            'members' => [
        ...
        'ConfigurationTagSet' => [
            'type' => 'list',
            'member' => ['shape' => 'ConfigurationTag', 'locationName' => 'item',],
        ],
        ...
        'CreateTagsRequest' => [
            ...
            'members' => ['configurationIds' => ['shape' => 'ConfigurationIdList',], 'tags' => ['shape' => 'TagSet',],],
        ],
        'CreateTagsResponse' => ['type' => 'structure', 'members' => [],],
        'CustomerAgentInfo' => [
            'type' => 'structure',
            'required' => [
                'activeAgents',
        ...
        'FilterValues' => ['type' => 'list', 'member' => ['shape' => 'FilterValue', 'locationName' => 'item',],],
        ...
        'TagKey' => ['type' => 'string',],
        'TagSet' => ['type' => 'list', 'member' => ['shape' => 'Tag', 'locationName' => 'item',],],
