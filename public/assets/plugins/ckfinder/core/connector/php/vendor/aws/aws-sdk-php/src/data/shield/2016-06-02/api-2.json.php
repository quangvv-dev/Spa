...
return [
    ...
    'shapes' => [
        ...
        'ListAttacksResponse' => [
            'type' => 'structure',
            'members' => ['AttackSummaries' => ['shape' => 'AttackSummaries',], 'NextToken' => ['shape' => 'Token',],],
        ],
        ...
        'MaxResults' => ['type' => 'integer', 'box' => true, 'max' => 100, 'min' => 0,],
        ...
        'SubResourceType' => ['type' => 'string', 'enum' => ['IP', 'URL',],],
        'Subscription' => [
            'type' => 'structure',
            'members' => [
