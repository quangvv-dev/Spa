...
return [
    ...
    'shapes' => [
        ...
        'BlueprintType' => ['type' => 'string', 'enum' => ['os', 'app',],],
        'Bundle' => [
            'type' => 'structure',
            'members' => [
                'price' => ['shape' => 'float',],
        ...
        'DiskList' => ['type' => 'list', 'member' => ['shape' => 'Disk',],],
        'Domain' => [
            'type' => 'structure',
            'members' => [
                'name' => ['shape' => 'ResourceName',],
        ...
        'DomainList' => ['type' => 'list', 'member' => ['shape' => 'Domain',],],
        ...
        'GetInstanceSnapshotsRequest' => [
            'type' => 'structure',
            'members' => ['pageToken' => ['shape' => 'string',],],
        ],
        ...
        'ImportKeyPairRequest' => [
            ...
            'members' => ['keyPairName' => ['shape' => 'ResourceName',], 'publicKeyBase64' => ['shape' => 'Base64',],],
        ],
        ...
        'KeyPairList' => ['type' => 'list', 'member' => ['shape' => 'KeyPair',],],
        'MetricDatapoint' => [
            'type' => 'structure',
            'members' => [
        ...
        'PortAccessType' => ['type' => 'string', 'enum' => ['Public', 'Private',],],
        'PortInfo' => [
            'type' => 'structure',
            'members' => [
                'fromPort' => ['shape' => 'Port',],
        ...
        'PutInstancePublicPortsRequest' => [
            ...
            'members' => ['portInfos' => ['shape' => 'PortInfoList',], 'instanceName' => ['shape' => 'ResourceName',],],
        ],
        ...
        'ResourceType' => [
            'type' => 'string',
            'enum' => ['Instance', 'StaticIp', 'KeyPair', 'InstanceSnapshot', 'Domain', 'PeeredVpc',],
        ],
        'ServiceException' => [
            'type' => 'structure',
            'members' => [
