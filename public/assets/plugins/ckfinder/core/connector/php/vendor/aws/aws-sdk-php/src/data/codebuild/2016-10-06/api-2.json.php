...
return [
    ...
    'shapes' => [
        'AccountLimitExceededException' => ['type' => 'structure', 'members' => [], 'exception' => true,],
        ...
        'BatchGetProjectsOutput' => [
            'type' => 'structure',
            'members' => ['projects' => ['shape' => 'Projects',], 'projectsNotFound' => ['shape' => 'ProjectNames',],],
        ],
        ...
        'LanguageType' => [
            'type' => 'string',
            'enum' => ['JAVA', 'PYTHON', 'NODE_JS', 'RUBY', 'GOLANG', 'DOCKER', 'ANDROID', 'BASE',],
        ],
        ...
        'SourceAuthType' => ['type' => 'string', 'enum' => ['OAUTH',],],
        'SourceType' => ['type' => 'string', 'enum' => ['CODECOMMIT', 'CODEPIPELINE', 'GITHUB', 'S3',],],
        'StartBuildInput' => [
            'type' => 'structure',
            'required' => ['projectName',],
            'members' => [
        ...
        'TimeOut' => ['type' => 'integer', 'max' => 480, 'min' => 5,],
