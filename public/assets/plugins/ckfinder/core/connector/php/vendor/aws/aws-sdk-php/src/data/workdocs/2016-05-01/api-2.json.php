...
return [
    ...
    'shapes' => [
        ...
        'ConcurrentModificationException' => [
            'type' => 'structure',
            'members' => ['Message' => ['shape' => 'ErrorMessageType',],],
        ...
        'CreateFolderResponse' => [
            'type' => 'structure',
            'members' => ['Metadata' => ['shape' => 'FolderMetadata',],],
        ],
        'CreateLabelsRequest' => [
            'type' => 'structure',
        ...
        'DeleteCommentRequest' => [
            ...
            'members' => [
                ...
                'CommentId' => ['shape' => 'CommentIdType', 'location' => 'uri', 'locationName' => 'CommentId',],
            ],
        ],
        'DeleteCustomMetadataRequest' => [
            ...
            'members' => [
                ...
                'Keys' => ['shape' => 'CustomMetadataKeyList', 'location' => 'querystring', 'locationName' => 'keys',],
                'DeleteAll' => ['shape' => 'BooleanType', 'location' => 'querystring', 'locationName' => 'deleteAll',],
            ],
        ],
        ...
        'DeleteLabelsRequest' => [
            ...
            'members' => [
                ...
                'Labels' => ['shape' => 'Labels', 'location' => 'querystring', 'locationName' => 'labels',],
                'DeleteAll' => ['shape' => 'BooleanType', 'location' => 'querystring', 'locationName' => 'deleteAll',],
            ],
        ],
        ...
        'DeleteNotificationSubscriptionRequest' => [
            ...
            'members' => [
                ...
                'OrganizationId' => ['shape' => 'IdType', 'location' => 'uri', 'locationName' => 'OrganizationId',],
            ],
        ],
        'DeleteUserRequest' => [
            'type' => 'structure',
        ...
        'DescribeActivitiesRequest' => [
            ...
            'members' => [
                ...
                'EndTime' => ['shape' => 'TimestampType', 'location' => 'querystring', 'locationName' => 'endTime',],
                'OrganizationId' => [
                    'shape' => 'IdType',
                    'location' => 'querystring',
                    'locationName' => 'organizationId',
        ...
        'DescribeActivitiesResponse' => [
            'type' => 'structure',
            'members' => ['UserActivities' => ['shape' => 'UserActivities',], 'Marker' => ['shape' => 'MarkerType',],],
        ],
        ...
        'DescribeDocumentVersionsRequest' => [
            ...
            'members' => [
                ...
                'Limit' => ['shape' => 'LimitType', 'location' => 'querystring', 'locationName' => 'limit',],
                'Include' => ['shape' => 'FieldNamesType', 'location' => 'querystring', 'locationName' => 'include',],
        ...
        'DescribeRootFoldersResponse' => [
            'type' => 'structure',
            'members' => ['Folders' => ['shape' => 'FolderMetadataList',], 'Marker' => ['shape' => 'PageMarkerType',],],
        ],
        'DescribeUsersRequest' => [
            ...
            'members' => [
                ...
                'Include' => ['shape' => 'UserFilterType', 'location' => 'querystring', 'locationName' => 'include',],
                'Order' => ['shape' => 'OrderType', 'location' => 'querystring', 'locationName' => 'order',],
        ...
        'Label' => ['type' => 'string', 'max' => 32, 'min' => 1, 'pattern' => '[a-zA-Z0-9._+-/=][a-zA-Z0-9 ._+-/=]*',],
        'Labels' => ['type' => 'list', 'member' => ['shape' => 'Label',], 'max' => 20,],
        ...
        'LimitType' => ['type' => 'integer', 'max' => 999, 'min' => 1,],
        'LocaleType' => [
            'type' => 'string',
        ...
        'PageMarkerType' => ['type' => 'string', 'max' => 2048, 'min' => 1,],
        'Participants' => [
            'type' => 'structure',
            'members' => ['Users' => ['shape' => 'UserMetadataList',], 'Groups' => ['shape' => 'GroupMetadataList',],],
        ],
        'PasswordType' => [
            'type' => 'string',
            'max' => 32,
        ...
        'PositiveSizeType' => ['type' => 'long', 'min' => 0,],
        'Principal' => [
            'type' => 'structure',
            'members' => [
                'Id' => ['shape' => 'IdType',],
        ...
        'RemoveResourcePermissionRequest' => [
            ...
            'members' => [
                ...
                'PrincipalType' => ['shape' => 'PrincipalType', 'location' => 'querystring', 'locationName' => 'type',],
            ],
        ],
        ...
        'StorageType' => ['type' => 'string', 'enum' => ['UNLIMITED', 'QUOTA',],],
        'Subscription' => [
            'type' => 'structure',
            'members' => [
        ...
        'TimeZoneIdType' => ['type' => 'string', 'max' => 256, 'min' => 1,],
        ...
        'UploadMetadata' => [
            'type' => 'structure',
            'members' => ['UploadUrl' => ['shape' => 'UrlType',], 'SignedHeaders' => ['shape' => 'SignedHeaderMap',],],
        ],
