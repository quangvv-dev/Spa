...
return [
    ...
    'shapes' => [
        ...
        'ChefConfiguration' => [
            'type' => 'structure',
            'members' => ['ManageBerkshelf' => ['shape' => 'Boolean',], 'BerkshelfVersion' => ['shape' => 'String',],],
        ],
        'CloneStackRequest' => [
            'type' => 'structure',
        ...
        'CloudWatchLogsTimeZone' => ['type' => 'string', 'enum' => ['LOCAL', 'UTC',],],
        'Command' => [
            'type' => 'structure',
            'members' => [
        ...
        'DeleteUserProfileRequest' => [
            'type' => 'structure',
            'required' => ['IamUserArn',],
            'members' => ['IamUserArn' => ['shape' => 'String',],],
        ],
        'Deployment' => [
            'type' => 'structure',
            'members' => [
        ...
        'DescribeElasticIpsResult' => [
            'type' => 'structure',
            'members' => ['ElasticIps' => ['shape' => 'ElasticIps',],],
        ],
        ...
        'DescribeRaidArraysResult' => [
            'type' => 'structure',
            'members' => ['RaidArrays' => ['shape' => 'RaidArrays',],],
        ],
        ...
        'DescribeUserProfilesRequest' => [
            'type' => 'structure',
            'members' => ['IamUserArns' => ['shape' => 'Strings',],],
        ],
        ...
        'EcsClusters' => ['type' => 'list', 'member' => ['shape' => 'EcsCluster',],],
        'ElasticIp' => [
            'type' => 'structure',
            'members' => [
                'Ip' => ['shape' => 'String',],
        ...
        'Minute' => ['type' => 'integer', 'box' => true, 'max' => 100, 'min' => 1,],
        ...
        'RootDeviceType' => ['type' => 'string', 'enum' => ['ebs', 'instance-store',],],
        'SelfUserProfile' => [
            'type' => 'structure',
            'members' => [
                'IamUserArn' => ['shape' => 'String',],
        ...
        'StackAttributesKeys' => ['type' => 'string', 'enum' => ['Color',],],
        ...
        'UpdateMyUserProfileRequest' => [
            'type' => 'structure',
            'members' => ['SshPublicKey' => ['shape' => 'String',],],
        ],
        ...
        'VirtualizationType' => ['type' => 'string', 'enum' => ['paravirtual', 'hvm',],],
        'Volume' => [
            'type' => 'structure',
            'members' => [
                'VolumeId' => ['shape' => 'String',],
