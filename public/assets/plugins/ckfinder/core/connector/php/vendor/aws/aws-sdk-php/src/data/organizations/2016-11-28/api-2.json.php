...
return [
    ...
    'shapes' => [
        ...
        'ActionType' => ['type' => 'string', 'enum' => ['INVITE', 'ENABLE_ALL_FEATURES', 'APPROVE_ALL_FEATURES',],],
        ...
        'ChildType' => ['type' => 'string', 'enum' => ['ACCOUNT', 'ORGANIZATIONAL_UNIT',],],
        ...
        'ParentType' => ['type' => 'string', 'enum' => ['ROOT', 'ORGANIZATIONAL_UNIT',],],
        'Parents' => ['type' => 'list', 'member' => ['shape' => 'Parent',],],
        'Policies' => ['type' => 'list', 'member' => ['shape' => 'PolicySummary',],],
        'Policy' => [
            'type' => 'structure',
            'members' => [
        ...
        'PolicyName' => ['type' => 'string', 'max' => 128, 'min' => 1,],
        ...
        'RoleName' => ['type' => 'string', 'pattern' => '[\\w+=,.@-]{1,64}',],
        'Root' => [
            'type' => 'structure',
            'members' => [
                'Id' => ['shape' => 'RootId',],
        ...
        'Roots' => ['type' => 'list', 'member' => ['shape' => 'Root',],],
        'ServiceException' => [
            'type' => 'structure',
            'members' => ['Message' => ['shape' => 'ExceptionMessage',],],
            'exception' => true,
