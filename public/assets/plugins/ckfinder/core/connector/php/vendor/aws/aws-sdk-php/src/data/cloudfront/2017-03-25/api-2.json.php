...
return [
    ...
    'shapes' => [
        ...
        'DistributionConfigWithTags' => [
            ...
            'members' => ['DistributionConfig' => ['shape' => 'DistributionConfig',], 'Tags' => ['shape' => 'Tags',],],
        ],
        'DistributionList' => [
            'type' => 'structure',
            'required' => ['Marker', 'MaxItems', 'IsTruncated', 'Quantity',],
        ...
        'QueryStringCacheKeys' => [
            'type' => 'structure',
            'required' => ['Quantity',],
            'members' => ['Quantity' => ['shape' => 'integer',], 'Items' => ['shape' => 'QueryStringCacheKeysList',],],
        ],
        ...
        'SslProtocolsList' => [
            'type' => 'list',
            'member' => ['shape' => 'SslProtocol', 'locationName' => 'SslProtocol',],
        ],
