    ...
    'partitions' => [
        [
            ...
            'services' => [
                ...
                'athena' => ['endpoints' => ['us-east-1' => [], 'us-east-2' => [], 'us-west-2' => [],],],
                'autoscaling' => [
                ...
                'firehose' => ['endpoints' => ['eu-west-1' => [], 'us-east-1' => [], 'us-west-2' => [],],],
                'gamelift' => [
                    'endpoints' => [
                        'ap-northeast-1' => [],
                        'ap-northeast-2' => [],
                ...
                'rekognition' => ['endpoints' => ['eu-west-1' => [], 'us-east-1' => [], 'us-west-2' => [],],],
                'route53' => [
                    'endpoints' => [
                        'aws-global' => [
                            'credentialScope' => ['region' => 'us-east-1',],
                ...
                'sms' => ['endpoints' => ['ap-southeast-2' => [], 'eu-west-1' => [], 'us-east-1' => [],],],
                'snowball' => [
                    'endpoints' => [
                        'ap-south-1' => [],
                        'ap-southeast-2' => [],
                ...
                'sts' => [
                    'defaults' => ['credentialScope' => ['region' => 'us-east-1',], 'hostname' => 'sts.amazonaws.com',],
                    'endpoints' => [
                        'ap-northeast-1' => [],
                        'ap-northeast-2' => [
        ...
        [
            ...
            'services' => [
                ...
                'ec2' => ['defaults' => ['protocols' => ['http', 'https',],], 'endpoints' => ['cn-north-1' => [],],],
                ...
                'sns' => ['defaults' => ['protocols' => ['http', 'https',],], 'endpoints' => ['cn-north-1' => [],],],
                'sqs' => [
                    'defaults' => [
                        'protocols' => ['http', 'https',],
                        'sslCommonName' => '{region}.queue.{dnsSuffix}',
