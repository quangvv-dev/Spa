...
return [
    ...
    'shapes' => [
        ...
        'BranchName' => ['type' => 'string', 'max' => 100, 'min' => 1,],
        ...
        'DifferenceList' => ['type' => 'list', 'member' => ['shape' => 'Difference',],],
        'Email' => ['type' => 'string',],
        ...
        'GetCommitInput' => [
            ...
            'members' => ['repositoryName' => ['shape' => 'RepositoryName',], 'commitId' => ['shape' => 'ObjectId',],],
        ],
        'GetCommitOutput' => [
            'type' => 'structure',
            'required' => ['commit',],
        ...
        'ParentList' => ['type' => 'list', 'member' => ['shape' => 'ObjectId',],],
        'Path' => ['type' => 'string',],
