...
return [
    ...
    'shapes' => [
        'AWSAccountNumber' => ['type' => 'string', 'max' => 16, 'min' => 2,],
        'AccountSettings' => [
            'type' => 'structure',
            'members' => [
        ...
        'AmazonResourceName' => ['type' => 'string', 'min' => 32,],
        ...
        'BillingMethod' => ['type' => 'string', 'enum' => ['METERED', 'UNMETERED',],],
        ...
        'ContentType' => ['type' => 'string', 'max' => 64, 'min' => 0,],
        'Counters' => [
            'type' => 'structure',
            'members' => [
                'total' => ['shape' => 'Integer',],
        ...
        'CreateDevicePoolResult' => [
            'type' => 'structure',
            'members' => ['devicePool' => ['shape' => 'DevicePool',],],
        ],
        ...
        'CurrencyCode' => ['type' => 'string', 'enum' => ['USD',],],
        ...
        'DeleteUploadResult' => ['type' => 'structure', 'members' => [],],
        'Device' => [
            'type' => 'structure',
            'members' => [
                'arn' => ['shape' => 'AmazonResourceName',],
        ...
        'DeviceAttribute' => [
            'type' => 'string',
            'enum' => ['ARN', 'PLATFORM', 'FORM_FACTOR', 'MANUFACTURER', 'REMOTE_ACCESS_ENABLED', 'APPIUM_VERSION',],
        ],
        ...
        'DevicePlatform' => ['type' => 'string', 'enum' => ['ANDROID', 'IOS',],],
        'DevicePool' => [
            'type' => 'structure',
            'members' => [
                'arn' => ['shape' => 'AmazonResourceName',],
        ...
        'InstallToRemoteAccessSessionResult' => [
            'type' => 'structure',
            'members' => ['appUpload' => ['shape' => 'Upload',],],
        ],
        ...
        'ListDevicesRequest' => [
            'type' => 'structure',
            'members' => ['arn' => ['shape' => 'AmazonResourceName',], 'nextToken' => ['shape' => 'PaginationToken',],],
        ],
        'ListDevicesResult' => [
            'type' => 'structure',
        ...
        'Metadata' => ['type' => 'string', 'max' => 8192, 'min' => 0,],
        'MonetaryAmount' => [
            'type' => 'structure',
            'members' => ['amount' => ['shape' => 'Double',], 'currencyCode' => ['shape' => 'CurrencyCode',],],
        ],
        'Name' => ['type' => 'string', 'max' => 256, 'min' => 0,],
        'NetworkProfile' => [
            'type' => 'structure',
            'members' => [
                'arn' => ['shape' => 'AmazonResourceName',],
        ...
        'OfferingIdentifier' => ['type' => 'string', 'min' => 32,],
        'OfferingPromotion' => [
            'type' => 'structure',
            'members' => [
        ...
        'PercentInteger' => ['type' => 'integer', 'max' => 100, 'min' => 0,],
        'Problem' => [
            'type' => 'structure',
            'members' => [
        ...
        'Problems' => ['type' => 'list', 'member' => ['shape' => 'Problem',],],
        'Project' => [
            'type' => 'structure',
            'members' => [
                'arn' => ['shape' => 'AmazonResourceName',],
        ...
        'Runs' => ['type' => 'list', 'member' => ['shape' => 'Run',],],
        'Sample' => [
            'type' => 'structure',
            'members' => [
                'arn' => ['shape' => 'AmazonResourceName',],
        ...
        'Suites' => ['type' => 'list', 'member' => ['shape' => 'Suite',],],
        'Test' => [
            'type' => 'structure',
            'members' => [
                'arn' => ['shape' => 'AmazonResourceName',],
        ...
        'TransactionIdentifier' => ['type' => 'string', 'min' => 32,],
        'TrialMinutes' => [
            'type' => 'structure',
            'members' => ['total' => ['shape' => 'Double',], 'remaining' => ['shape' => 'Double',],],
        ],
        'URL' => ['type' => 'string', 'max' => 2048, 'min' => 0,],
        'UniqueProblem' => [
            'type' => 'structure',
