...
return [
    ...
    'operations' => [
        ...
        'PutMetricAlarm' => [
            ...
            'errors' => [['shape' => 'LimitExceededFault',],],
        ],
        'PutMetricData' => [
            'name' => 'PutMetricData',
            'http' => ['method' => 'POST', 'requestUri' => '/',],
    ...
    'shapes' => [
        'ActionPrefix' => ['type' => 'string', 'max' => 1024, 'min' => 1,],
        ...
        'InternalServiceFault' => [
            ...
            'error' => ['code' => 'InternalServiceError', 'httpStatusCode' => 500,],
            'exception' => true,
            'xmlOrder' => ['Message',],
        ],
        'InvalidFormatFault' => [
        ...
        'MaxRecords' => ['type' => 'integer', 'max' => 100, 'min' => 1,],
        'Metric' => [
            'type' => 'structure',
            'members' => [
                'Namespace' => ['shape' => 'Namespace',],
        ...
        'NextToken' => ['type' => 'string', 'max' => 1024, 'min' => 0,],
        ...
        'StateReason' => ['type' => 'string', 'max' => 1023, 'min' => 0,],
        ...
        'TreatMissingData' => ['type' => 'string', 'max' => 255, 'min' => 1,],
    ],
];
