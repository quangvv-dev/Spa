...
return [
    ...
    'shapes' => [
        ...
        'AuthorizerType' => ['type' => 'string', 'enum' => ['TOKEN', 'COGNITO_USER_POOLS',],],
        'Authorizers' => [
            'type' => 'structure',
            'members' => [
                'position' => ['shape' => 'String',],
        ...
        'CacheClusterStatus' => [
            'type' => 'string',
            'enum' => ['CREATE_IN_PROGRESS', 'AVAILABLE', 'DELETE_IN_PROGRESS', 'NOT_AVAILABLE', 'FLUSH_IN_PROGRESS',],
        ],
        'ClientCertificate' => [
            'type' => 'structure',
            'members' => [
        ...
        'CreateAuthorizerRequest' => [
            ...
            'members' => [
                'restApiId' => ['shape' => 'String', 'location' => 'uri', 'locationName' => 'restapi_id',],
                'name' => ['shape' => 'String',],
                'type' => ['shape' => 'AuthorizerType',],
                'providerARNs' => ['shape' => 'ListOfARNs',],
                'authType' => ['shape' => 'String',],
        ...
        'CreateBasePathMappingRequest' => [
            ...
            'members' => [
                'domainName' => ['shape' => 'String', 'location' => 'uri', 'locationName' => 'domain_name',],
                'basePath' => ['shape' => 'String',],
                'restApiId' => ['shape' => 'String',],
                'stage' => ['shape' => 'String',],
            ],
        ...
        'CreateUsagePlanKeyRequest' => [
            ...
            'members' => [
                'usagePlanId' => ['shape' => 'String', 'location' => 'uri', 'locationName' => 'usageplanId',],
                'keyId' => ['shape' => 'String',],
        ...
        'DeleteDocumentationVersionRequest' => [
            ...
            'members' => [
                'restApiId' => ['shape' => 'String', 'location' => 'uri', 'locationName' => 'restapi_id',],
                'documentationVersion' => ['shape' => 'String', 'location' => 'uri', 'locationName' => 'doc_version',],
            ],
        ],
        ...
        'GetApiKeyRequest' => [
            ...
            'required' => ['apiKey',],
            'members' => [
                'apiKey' => ['shape' => 'String', 'location' => 'uri', 'locationName' => 'api_Key',],
                'includeValue' => [
        ...
        'GetDocumentationPartsRequest' => [
            ...
            'members' => [
                'restApiId' => ['shape' => 'String', 'location' => 'uri', 'locationName' => 'restapi_id',],
                'type' => ['shape' => 'DocumentationPartType', 'location' => 'querystring', 'locationName' => 'type',],
                'nameQuery' => ['shape' => 'String', 'location' => 'querystring', 'locationName' => 'name',],
        ...
        'GetStagesRequest' => [
            ...
            'members' => [
                'restApiId' => ['shape' => 'String', 'location' => 'uri', 'locationName' => 'restapi_id',],
                'deploymentId' => ['shape' => 'String', 'location' => 'querystring', 'locationName' => 'deploymentId',],
            ],
        ],
        ...
        'MethodSnapshot' => [
            'type' => 'structure',
            'members' => ['authorizationType' => ['shape' => 'String',], 'apiKeyRequired' => ['shape' => 'Boolean',],],
        ],
        'Model' => [
            'type' => 'structure',
            'members' => [
