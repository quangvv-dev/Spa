...
return [
    ...
    'shapes' => [
        ...
        'Budget' => [
            'type' => 'structure',
            'required' => ['BudgetName', 'BudgetLimit', 'CostTypes', 'TimeUnit', 'TimePeriod', 'BudgetType',],
            'members' => [
        ...
        'BudgetType' => ['type' => 'string', 'enum' => ['USAGE', 'COST',],],
        ...
        'CostTypes' => [
            'type' => 'structure',
            'required' => ['IncludeTax', 'IncludeSubscription', 'UseBlended',],
            'members' => [
        ...
        'DescribeSubscribersForNotificationResponse' => [
            'type' => 'structure',
            'members' => ['Subscribers' => ['shape' => 'Subscribers',], 'NextToken' => ['shape' => 'GenericString',],],
        ],
        ...
        'NotificationThreshold' => ['type' => 'double', 'max' => 300, 'min' => 0.10000000000000001,],
        ...
        'Spend' => [
            ...
            'members' => ['Amount' => ['shape' => 'NumericValue',], 'Unit' => ['shape' => 'GenericString',],],
        ],
        'Subscriber' => [
            'type' => 'structure',
        ...
        'TimeUnit' => ['type' => 'string', 'enum' => ['MONTHLY', 'QUARTERLY', 'ANNUALLY',],],
        'UpdateBudgetRequest' => [
            'type' => 'structure',
