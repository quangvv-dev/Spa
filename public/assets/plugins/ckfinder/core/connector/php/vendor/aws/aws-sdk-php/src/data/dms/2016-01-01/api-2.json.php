...
return [
    ...
    'shapes' => [
        ...
        'ConnectionList' => ['type' => 'list', 'member' => ['shape' => 'Connection', 'locationName' => 'Connection',],],
        ...
        'DynamoDbSettings' => [
            ...
            'members' => ['ServiceAccessRoleArn' => ['shape' => 'String',],],
        ],
        'Endpoint' => [
            'type' => 'structure',
            'members' => [
        ...
        'EndpointList' => ['type' => 'list', 'member' => ['shape' => 'Endpoint', 'locationName' => 'Endpoint',],],
        'Event' => [
            'type' => 'structure',
            'members' => [
                'SourceIdentifier' => ['shape' => 'String',],
        ...
        'EventCategoryGroupList' => [
            'type' => 'list',
            'member' => ['shape' => 'EventCategoryGroup', 'locationName' => 'EventCategoryGroup',],
        ],
        ...
        'OrderableReplicationInstanceList' => [
            'type' => 'list',
            'member' => ['shape' => 'OrderableReplicationInstance', 'locationName' => 'OrderableReplicationInstance',],
        ],
        ...
        'ReplicationInstanceList' => [
            'type' => 'list',
            'member' => ['shape' => 'ReplicationInstance', 'locationName' => 'ReplicationInstance',],
        ],
        ...
        'ReplicationSubnetGroups' => [
            'type' => 'list',
            'member' => ['shape' => 'ReplicationSubnetGroup', 'locationName' => 'ReplicationSubnetGroup',],
        ],
        'ReplicationTask' => [
            'type' => 'structure',
            'members' => [
        ...
        'ReplicationTaskList' => [
            'type' => 'list',
            'member' => ['shape' => 'ReplicationTask', 'locationName' => 'ReplicationTask',],
        ],
        ...
        'SchemaList' => ['type' => 'list', 'member' => ['shape' => 'String',],],
        ...
        'SupportedEndpointTypeList' => [
            'type' => 'list',
            'member' => ['shape' => 'SupportedEndpointType', 'locationName' => 'SupportedEndpointType',],
        ],
        ...
        'TestConnectionResponse' => [
            'type' => 'structure',
            'members' => ['Connection' => ['shape' => 'Connection',],],
        ],
        ...
        'VpcSecurityGroupMembershipList' => [
            'type' => 'list',
            'member' => ['shape' => 'VpcSecurityGroupMembership', 'locationName' => 'VpcSecurityGroupMembership',],
        ],
    ],
];
