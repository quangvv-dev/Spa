...
return [
    ...
    'shapes' => [
        ...
        'ConflictException' => [
            'type' => 'structure',
            'members' => ['Message' => ['shape' => 'NonEmptyString',],],
            'exception' => true,
        ],
        'CreateAliasInput' => [
            'type' => 'structure',
        ...
        'CreateGameSessionOutput' => [
            'type' => 'structure',
            'members' => ['GameSession' => ['shape' => 'GameSession',],],
        ],
        ...
        'GamePropertyValue' => ['type' => 'string', 'max' => 96,],
        'GameSession' => [
            'type' => 'structure',
            'members' => [
        ...
        'GameSessionList' => ['type' => 'list', 'member' => ['shape' => 'GameSession',],],
        ...
        'GameSessionPlacementState' => [
            'type' => 'string',
            'enum' => ['PENDING', 'FULFILLED', 'CANCELLED', 'TIMED_OUT',],
        ],
        'GameSessionQueue' => [
            'type' => 'structure',
            'members' => [
        ...
        'InstanceId' => ['type' => 'string', 'pattern' => '[a-zA-Z0-9\\.-]+',],
        ...
        'PositiveInteger' => ['type' => 'integer', 'min' => 1,],
        'PositiveLong' => ['type' => 'long', 'min' => 1,],
