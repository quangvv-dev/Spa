...
return [
    ...
    'operations' => [
        ...
        'DeprecateDomain' => [
            ...
            'errors' => [
                ['shape' => 'UnknownResourceFault', 'exception' => true,],
                ['shape' => 'DomainDeprecatedFault', 'exception' => true,],
                ['shape' => 'OperationNotPermittedFault', 'exception' => true,],
            ],
        ],
        ...
        'ListDomains' => [
            ...
            'errors' => [['shape' => 'OperationNotPermittedFault', 'exception' => true,],],
        ],
        ...
        'RegisterActivityType' => [
            ...
            'errors' => [
                ['shape' => 'TypeAlreadyExistsFault', 'exception' => true,],
                ['shape' => 'LimitExceededFault', 'exception' => true,],
                ['shape' => 'UnknownResourceFault', 'exception' => true,],
                ['shape' => 'OperationNotPermittedFault', 'exception' => true,],
            ],
        ...
        'RegisterDomain' => [
            ...
            'errors' => [
                ['shape' => 'DomainAlreadyExistsFault', 'exception' => true,],
                ['shape' => 'LimitExceededFault', 'exception' => true,],
                ['shape' => 'OperationNotPermittedFault', 'exception' => true,],
            ],
        ],
        ...
        'StartWorkflowExecution' => [
            ...
            'errors' => [
                ['shape' => 'UnknownResourceFault', 'exception' => true,],
                ['shape' => 'TypeDeprecatedFault', 'exception' => true,],
                ['shape' => 'WorkflowExecutionAlreadyStartedFault', 'exception' => true,],
                ['shape' => 'LimitExceededFault', 'exception' => true,],
                ['shape' => 'OperationNotPermittedFault', 'exception' => true,],
    ...
    'shapes' => [
        'ActivityId' => ['type' => 'string', 'min' => 1, 'max' => 256,],
        'ActivityTask' => [
            'type' => 'structure',
        ...
        'Arn' => ['type' => 'string', 'min' => 1, 'max' => 1224,],
        ...
        'DomainName' => ['type' => 'string', 'min' => 1, 'max' => 256,],
        'DurationInDays' => ['type' => 'string', 'min' => 1, 'max' => 8,],
        'DurationInSeconds' => ['type' => 'string', 'min' => 1, 'max' => 8,],
        'DurationInSecondsOptional' => ['type' => 'string', 'max' => 8,],
        ...
        'FunctionId' => ['type' => 'string', 'min' => 1, 'max' => 256,],
        'FunctionInput' => ['type' => 'string', 'min' => 1, 'max' => 32768,],
        'FunctionName' => ['type' => 'string', 'min' => 1, 'max' => 64,],
        ...
        'History' => [
            'type' => 'structure',
            'required' => ['events',],
            'members' => ['events' => ['shape' => 'HistoryEventList',], 'nextPageToken' => ['shape' => 'PageToken',],],
        ],
        'HistoryEvent' => [
            'type' => 'structure',
        ...
        'LimitedData' => ['type' => 'string', 'max' => 2048,],
        ...
        'MarkerName' => ['type' => 'string', 'min' => 1, 'max' => 256,],
        ...
        'OpenDecisionTasksCount' => ['type' => 'integer', 'min' => 0, 'max' => 1,],
        'OperationNotPermittedFault' => [
            'type' => 'structure',
            'members' => ['message' => ['shape' => 'ErrorMessage',],],
            'exception' => true,
        ],
        'PageSize' => ['type' => 'integer', 'min' => 0, 'max' => 1000,],
        ...
        'Run' => ['type' => 'structure', 'members' => ['runId' => ['shape' => 'RunId',],],],
        'RunId' => ['type' => 'string', 'min' => 1, 'max' => 64,],
        'RunIdOptional' => ['type' => 'string', 'max' => 64,],
        ...
        'SignalName' => ['type' => 'string', 'min' => 1, 'max' => 256,],
        ...
        'TaskPriority' => ['type' => 'string', 'max' => 11,],
        'TaskToken' => ['type' => 'string', 'min' => 1, 'max' => 1024,],
        ...
        'TimerId' => ['type' => 'string', 'min' => 1, 'max' => 256,],
        ...
        'WorkflowExecution' => [
            ...
            'members' => ['workflowId' => ['shape' => 'WorkflowId',], 'runId' => ['shape' => 'RunId',],],
        ],
        ...
        'WorkflowExecutionCompletedEventAttributes' => [
            'type' => 'structure',
            'required' => ['decisionTaskCompletedEventId',],
            'members' => ['result' => ['shape' => 'Data',], 'decisionTaskCompletedEventId' => ['shape' => 'EventId',],],
        ],
        ...
        'WorkflowId' => ['type' => 'string', 'min' => 1, 'max' => 256,],
        'WorkflowType' => [
            'type' => 'structure',
            'required' => ['name', 'version',],
            'members' => ['name' => ['shape' => 'Name',], 'version' => ['shape' => 'Version',],],
