...
return [
    ...
    'shapes' => [
        ...
        'DataSchema' => ['type' => 'string', 'max' => 131071,],
        'DataSource' => [
            'type' => 'structure',
            'members' => [
                'DataSourceId' => ['shape' => 'EntityId',],
        ...
        'DetailsValue' => ['type' => 'string', 'min' => 1,],
        ...
        'Evaluations' => ['type' => 'list', 'member' => ['shape' => 'Evaluation',],],
        ...
        'Message' => ['type' => 'string', 'max' => 10240,],
        'PageLimit' => ['type' => 'integer', 'min' => 1, 'max' => 100,],
        'PerformanceMetrics' => [
            'type' => 'structure',
        ...
        'SortOrder' => ['type' => 'string', 'enum' => ['asc', 'dsc',],],
        ...
        'TagList' => ['type' => 'list', 'member' => ['shape' => 'Tag',], 'max' => 100,],
        'TagValue' => [
            'type' => 'string',
            'min' => 0,
            'max' => 256,
