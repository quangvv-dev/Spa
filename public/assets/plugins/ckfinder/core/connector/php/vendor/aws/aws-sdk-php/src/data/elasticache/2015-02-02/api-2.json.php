...
return [
    ...
    'shapes' => [
        ...
        'AZMode' => ['type' => 'string', 'enum' => ['single-az', 'cross-az',],],
        ...
        'ChangeType' => ['type' => 'string', 'enum' => ['immediate', 'requires-reboot',],],
        ...
        'CreateCacheSecurityGroupMessage' => [
            ...
            'members' => ['CacheSecurityGroupName' => ['shape' => 'String',], 'Description' => ['shape' => 'String',],],
        ],
        ...
        'InvalidARNFault' => [
            'type' => 'structure',
            'members' => [],
            'error' => ['code' => 'InvalidARN', 'httpStatusCode' => 400, 'senderFault' => true,],
            'exception' => true,
        ],
