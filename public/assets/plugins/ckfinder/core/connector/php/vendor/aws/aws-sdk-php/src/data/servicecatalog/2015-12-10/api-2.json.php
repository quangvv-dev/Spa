...
return [
    ...
    'shapes' => [
        ...
        'ParameterKey' => ['type' => 'string', 'max' => 1000, 'min' => 1,],
        ...
        'PortfolioDisplayName' => ['type' => 'string', 'max' => 100, 'min' => 1,],
        ...
        'ProviderName' => ['type' => 'string', 'max' => 20, 'min' => 1,],
        ...
        'ProvisionedProductStatus' => [
            'type' => 'string',
            'enum' => ['AVAILABLE', 'UNDER_CHANGE', 'TAINTED', 'ERROR',],
        ],
        ...
        'ResourceARN' => ['type' => 'string', 'max' => 150, 'min' => 1,],
