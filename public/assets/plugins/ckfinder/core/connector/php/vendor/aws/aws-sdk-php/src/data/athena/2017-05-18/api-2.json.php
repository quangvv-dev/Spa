...
return [
    ...
    'shapes' => [
        ...
        'DatabaseString' => ['type' => 'string', 'max' => 32, 'min' => 1,],
        'Date' => ['type' => 'timestamp',],
        ...
        'EncryptionConfiguration' => [
            ...
            'members' => ['EncryptionOption' => ['shape' => 'EncryptionOption',], 'KmsKey' => ['shape' => 'String',],],
        ],
        ...
        'ListNamedQueriesInput' => [
            'type' => 'structure',
            'members' => ['NextToken' => ['shape' => 'Token',], 'MaxResults' => ['shape' => 'MaxNamedQueriesCount',],],
        ],
        ...
        'ResultSet' => [
            'type' => 'structure',
            'members' => ['Rows' => ['shape' => 'RowList',], 'ResultSetMetadata' => ['shape' => 'ResultSetMetadata',],],
        ],
        ...
        'StartQueryExecutionInput' => [
            'type' => 'structure',
            'required' => ['QueryString', 'ResultConfiguration',],
            'members' => [
                'QueryString' => ['shape' => 'QueryString',],
                'ClientRequestToken' => ['shape' => 'IdempotencyToken', 'idempotencyToken' => true,],
                'QueryExecutionContext' => ['shape' => 'QueryExecutionContext',],
