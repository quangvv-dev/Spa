...
return [
    ...
    'operations' => [
        ...
        'GetChange' => [
            'name' => 'GetChange',
            'http' => ['method' => 'GET', 'requestUri' => '/2013-04-01/change/{Id}',],
    ...
    'shapes' => [
        ...
        'ChildHealthCheckList' => [
            'type' => 'list',
            'member' => ['shape' => 'HealthCheckId', 'locationName' => 'ChildHealthCheck',],
            'max' => 256,
        ],
        ...
        'CreateTrafficPolicyVersionRequest' => [
            ...
            'members' => [
                'Id' => ['shape' => 'TrafficPolicyId', 'location' => 'uri', 'locationName' => 'Id',],
                'Document' => ['shape' => 'TrafficPolicyDocument',],
                'Comment' => ['shape' => 'TrafficPolicyComment',],
            ],
        ],
        ...
        'DelegationSetNameServers' => [
            'type' => 'list',
            'member' => ['shape' => 'DNSName', 'locationName' => 'NameServer',],
            'min' => 1,
        ],
        ...
        'DimensionList' => [
            'type' => 'list',
            'member' => ['shape' => 'Dimension', 'locationName' => 'Dimension',],
            'max' => 10,
        ],
        ...
        'HealthCheckRegionList' => [
            'type' => 'list',
            'member' => ['shape' => 'HealthCheckRegion', 'locationName' => 'Region',],
            'max' => 64,
            'min' => 3,
        ],
        'HealthCheckType' => [
        ...
        'InvalidChangeBatch' => [
            'type' => 'structure',
            'members' => ['messages' => ['shape' => 'ErrorMessages',],],
            'exception' => true,
        ],
        'InvalidDomainName' => [
            'type' => 'structure',
        ...
        'ListGeoLocationsRequest' => [
            ...
            'members' => [
                ...
                'MaxItems' => ['shape' => 'PageMaxItems', 'location' => 'querystring', 'locationName' => 'maxitems',],
            ],
        ],
        ...
        'RRType' => [
            'type' => 'string',
            'enum' => ['SOA', 'A', 'TXT', 'NS', 'CNAME', 'MX', 'NAPTR', 'PTR', 'SRV', 'SPF', 'AAAA',],
        ],
        'RecordData' => [
            'type' => 'list',
        ...
        'ResourceRecords' => [
            'type' => 'list',
            'member' => ['shape' => 'ResourceRecord', 'locationName' => 'ResourceRecord',],
            'min' => 1,
        ],
        'ResourceTagSet' => [
            'type' => 'structure',
        ...
        'TagKeyList' => [
            'type' => 'list',
            'member' => ['shape' => 'TagKey', 'locationName' => 'Key',],
            'max' => 10,
            'min' => 1,
        ],
        'TagList' => [
        ...
        'TagResourceIdList' => [
            'type' => 'list',
            'member' => ['shape' => 'TagResourceId', 'locationName' => 'ResourceId',],
            'max' => 10,
            'min' => 1,
        ],
        ...
        'TestDNSAnswerRequest' => [
            ...
            'members' => [
                ...
                'RecordName' => ['shape' => 'DNSName', 'location' => 'querystring', 'locationName' => 'recordname',],
                'RecordType' => ['shape' => 'RRType', 'location' => 'querystring', 'locationName' => 'recordtype',],
                'ResolverIP' => ['shape' => 'IPAddress', 'location' => 'querystring', 'locationName' => 'resolverip',],
                'EDNS0ClientSubnetIP' => [
                    'shape' => 'IPAddress',
                    'location' => 'querystring',
        ...
        'UpdateTrafficPolicyInstanceRequest' => [
            ...
            'members' => [
                'Id' => ['shape' => 'TrafficPolicyInstanceId', 'location' => 'uri', 'locationName' => 'Id',],
                'TTL' => ['shape' => 'TTL',],
                'TrafficPolicyId' => ['shape' => 'TrafficPolicyId',],
                'TrafficPolicyVersion' => ['shape' => 'TrafficPolicyVersion',],
            ],
