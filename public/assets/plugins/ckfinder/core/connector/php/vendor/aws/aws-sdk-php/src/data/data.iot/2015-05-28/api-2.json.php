...
return [
    ...
    'operations' => [
        ...
        'Publish' => [
            'name' => 'Publish',
            'http' => ['method' => 'POST', 'requestUri' => '/topics/{topic}',],
    ...
    'shapes' => [
        ...
        'DeleteThingShadowResponse' => [
            'type' => 'structure',
            'required' => ['payload',],
            'members' => ['payload' => ['shape' => 'JsonDocument',],],
            'payload' => 'payload',
        ],
        ...
        'PublishRequest' => [
            ...
            'required' => ['topic',],
            'members' => [
                'topic' => ['shape' => 'Topic', 'location' => 'uri', 'locationName' => 'topic',],
                'qos' => ['shape' => 'Qos', 'location' => 'querystring', 'locationName' => 'qos',],
                'payload' => ['shape' => 'Payload',],
            ],
            'payload' => 'payload',
        ],
        'Qos' => ['type' => 'integer', 'max' => 1, 'min' => 0,],
