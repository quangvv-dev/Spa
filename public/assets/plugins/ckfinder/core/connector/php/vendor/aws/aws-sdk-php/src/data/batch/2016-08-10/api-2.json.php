...
return [
    ...
    'operations' => [
        'CancelJob' => [
            'name' => 'CancelJob',
            'http' => ['method' => 'POST', 'requestUri' => '/v1/canceljob',],
        ...
        'DescribeJobs' => [
            'name' => 'DescribeJobs',
            'http' => ['method' => 'POST', 'requestUri' => '/v1/describejobs',],
        ...
        'ListJobs' => [
            'name' => 'ListJobs',
            'http' => ['method' => 'POST', 'requestUri' => '/v1/listjobs',],
        ...
        'SubmitJob' => [
            'name' => 'SubmitJob',
            'http' => ['method' => 'POST', 'requestUri' => '/v1/submitjob',],
        ...
        'TerminateJob' => [
            'name' => 'TerminateJob',
            'http' => ['method' => 'POST', 'requestUri' => '/v1/terminatejob',],
    ...
    'shapes' => [
        ...
        'CEState' => ['type' => 'string', 'enum' => ['ENABLED', 'DISABLED',],],
        'CEStatus' => [
            'type' => 'string',
        ...
        'JQState' => ['type' => 'string', 'enum' => ['ENABLED', 'DISABLED',],],
        'JQStatus' => [
            'type' => 'string',
            'enum' => ['CREATING', 'UPDATING', 'DELETING', 'DELETED', 'VALID', 'INVALID',],
        ],
        ...
        'JobDefinitionType' => ['type' => 'string', 'enum' => ['container',],],
        'JobDependency' => ['type' => 'structure', 'members' => ['jobId' => ['shape' => 'String',],],],
