...
return [
    ...
    'shapes' => [
        ...
        'HealthCheckIntervalSeconds' => ['type' => 'integer', 'max' => 300, 'min' => 5,],
        ...
        'HealthUnavailableException' => [
            'type' => 'structure',
            'members' => [],
            'error' => ['code' => 'HealthUnavailable', 'httpStatusCode' => 500,],
            'exception' => true,
        ],
        ...
        'Limit' => [
            'type' => 'structure',
            'members' => ['Name' => ['shape' => 'Name',], 'Max' => ['shape' => 'Max',],],
        ],
        ...
        'LoadBalancerStateEnum' => ['type' => 'string', 'enum' => ['active', 'provisioning', 'failed',],],
        'LoadBalancerTypeEnum' => ['type' => 'string', 'enum' => ['application',],],
        ...
        'PageSize' => ['type' => 'integer', 'max' => 400, 'min' => 1,],
        ...
        'ProtocolEnum' => ['type' => 'string', 'enum' => ['HTTP', 'HTTPS',],],
        ...
        'RuleArn' => ['type' => 'string',],
        'RuleArns' => ['type' => 'list', 'member' => ['shape' => 'RuleArn',],],
        'RuleCondition' => [
            'type' => 'structure',
        ...
        'RulePriority' => ['type' => 'integer', 'max' => 99999, 'min' => 1,],
        ...
        'SslPolicies' => ['type' => 'list', 'member' => ['shape' => 'SslPolicy',],],
        'SslPolicy' => [
            'type' => 'structure',
            'members' => [
        ...
        'Subnets' => ['type' => 'list', 'member' => ['shape' => 'SubnetId',],],
        'Tag' => [
            'type' => 'structure',
            'required' => ['Key',],
        ...
        'TargetHealthStateEnum' => [
            'type' => 'string',
            'enum' => ['initial', 'healthy', 'unhealthy', 'unused', 'draining',],
        ],
