...
return [
    ...
    'shapes' => [
        ...
        'AddTagsResponse' => ['type' => 'structure', 'members' => [],],
        ...
        'ListTagsResponse' => [
            'type' => 'structure',
            'members' => ['ResourceTagList' => ['shape' => 'ResourceTagList',], 'NextToken' => ['shape' => 'String',],],
        ],
        'LookupAttribute' => [
            'type' => 'structure',
        ...
        'RemoveTagsResponse' => ['type' => 'structure', 'members' => [],],
        'Resource' => [
            'type' => 'structure',
        ...
        'StopLoggingResponse' => ['type' => 'structure', 'members' => [],],
        'String' => ['type' => 'string',],
        'Tag' => [
            'type' => 'structure',
            'required' => ['Key',],
        ...
        'TagsList' => ['type' => 'list', 'member' => ['shape' => 'Tag',],],
        'Trail' => [
            'type' => 'structure',
            'members' => [
                'Name' => ['shape' => 'String',],
