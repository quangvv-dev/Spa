...
return [
    ...
    'shapes' => [
        ...
        'ByteMatchSetUpdates' => ['type' => 'list', 'member' => ['shape' => 'ByteMatchSetUpdate',],],
        ...
        'CreateXssMatchSetResponse' => [
            'type' => 'structure',
            'members' => ['XssMatchSet' => ['shape' => 'XssMatchSet',], 'ChangeToken' => ['shape' => 'ChangeToken',],],
        ],
        ...
        'GetXssMatchSetResponse' => [
            'type' => 'structure',
            'members' => ['XssMatchSet' => ['shape' => 'XssMatchSet',],],
        ],
        'HTTPHeader' => [
            'type' => 'structure',
            'members' => ['Name' => ['shape' => 'HeaderName',], 'Value' => ['shape' => 'HeaderValue',],],
        ],
        'HTTPHeaders' => ['type' => 'list', 'member' => ['shape' => 'HTTPHeader',],],
        ...
        'IPSetUpdates' => ['type' => 'list', 'member' => ['shape' => 'IPSetUpdate',],],
        ...
        'PredicateType' => [
            'type' => 'string',
            'enum' => ['IPMatch', 'ByteMatch', 'SqlInjectionMatch', 'SizeConstraint', 'XssMatch',],
        ],
        'Predicates' => ['type' => 'list', 'member' => ['shape' => 'Predicate',],],
        'RateBasedRule' => [
            'type' => 'structure',
        ...
        'RateKey' => ['type' => 'string', 'enum' => ['IP',],],
        'RateLimit' => ['type' => 'long', 'min' => 2000,],
        ...
        'Size' => ['type' => 'long', 'max' => 21474836480, 'min' => 0,],
        'SizeConstraint' => [
            'type' => 'structure',
        ...
        'SizeConstraintSetUpdates' => ['type' => 'list', 'member' => ['shape' => 'SizeConstraintSetUpdate',],],
        ...
        'WafRuleType' => ['type' => 'string', 'enum' => ['REGULAR', 'RATE_BASED',],],
        'WebACL' => [
            'type' => 'structure',
        ...
        'WebACLUpdate' => [
            ...
            'members' => ['Action' => ['shape' => 'ChangeAction',], 'ActivatedRule' => ['shape' => 'ActivatedRule',],],
        ],
        ...
        'XssMatchSetUpdate' => [
            ...
            'members' => ['Action' => ['shape' => 'ChangeAction',], 'XssMatchTuple' => ['shape' => 'XssMatchTuple',],],
        ],
        'XssMatchSetUpdates' => ['type' => 'list', 'member' => ['shape' => 'XssMatchSetUpdate',],],
        'XssMatchTuple' => [
            'type' => 'structure',
            'required' => ['FieldToMatch', 'TextTransformation',],
            'members' => [
