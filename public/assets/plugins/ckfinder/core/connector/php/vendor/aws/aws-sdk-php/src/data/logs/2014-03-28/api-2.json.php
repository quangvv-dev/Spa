...
return [
    ...
    'shapes' => [
        'AccessPolicy' => ['type' => 'string', 'min' => 1,],
        'Arn' => ['type' => 'string',],
        ...
        'DataAlreadyAcceptedException' => [
            'type' => 'structure',
            'members' => ['expectedSequenceToken' => ['shape' => 'SequenceToken',],],
            'exception' => true,
        ],
        'Days' => ['type' => 'integer',],
        ...
        'DescribeMetricFiltersResponse' => [
            'type' => 'structure',
            'members' => ['metricFilters' => ['shape' => 'MetricFilters',], 'nextToken' => ['shape' => 'NextToken',],],
        ],
        ...
        'Distribution' => ['type' => 'string', 'enum' => ['Random', 'ByLogStream',],],
        'EventId' => ['type' => 'string',],
        'EventMessage' => ['type' => 'string', 'min' => 1,],
        ...
        'ExportTaskExecutionInfo' => [
            'type' => 'structure',
            'members' => ['creationTime' => ['shape' => 'Timestamp',], 'completionTime' => ['shape' => 'Timestamp',],],
        ],
        'ExportTaskId' => ['type' => 'string', 'max' => 512, 'min' => 1,],
        'ExportTaskName' => ['type' => 'string', 'max' => 512, 'min' => 1,],
        'ExportTaskStatus' => [
            'type' => 'structure',
            'members' => [
        ...
        'FilterPattern' => ['type' => 'string', 'max' => 1024, 'min' => 0,],
        'FilteredLogEvent' => [
            'type' => 'structure',
            'members' => [
                'logStreamName' => ['shape' => 'LogStreamName',],
        ...
        'LogGroups' => ['type' => 'list', 'member' => ['shape' => 'LogGroup',],],
        'LogStream' => [
            'type' => 'structure',
            'members' => [
                'logStreamName' => ['shape' => 'LogStreamName',],
        ...
        'MetricValue' => ['type' => 'string', 'max' => 100,],
