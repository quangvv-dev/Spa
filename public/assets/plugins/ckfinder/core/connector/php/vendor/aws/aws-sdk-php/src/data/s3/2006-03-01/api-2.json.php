...
return [
    ...
    'operations' => [
        ...
        'DeleteBucket' => [
            'name' => 'DeleteBucket',
            'http' => ['method' => 'DELETE', 'requestUri' => '/{Bucket}',],
        ...
        'DeleteObjects' => [
            'name' => 'DeleteObjects',
            'http' => ['method' => 'POST', 'requestUri' => '/{Bucket}?delete',],
    ...
    'shapes' => [
        ...
        'CORSRule' => [
            ...
            'members' => [
                'AllowedHeaders' => ['shape' => 'AllowedHeaders', 'locationName' => 'AllowedHeader',],
        ...
        'CopyObjectRequest' => [
            ...
            'members' => [
                'ACL' => ['shape' => 'ObjectCannedACL', 'location' => 'header', 'locationName' => 'x-amz-acl',],
                'Bucket' => ['shape' => 'BucketName', 'location' => 'uri', 'locationName' => 'Bucket',],
                'CacheControl' => [
                    'shape' => 'CacheControl',
                    'location' => 'header',
                ...
                'GrantRead' => ['shape' => 'GrantRead', 'location' => 'header', 'locationName' => 'x-amz-grant-read',],
                'GrantReadACP' => [
                    'shape' => 'GrantReadACP',
                    'location' => 'header',
                ...
                'Tagging' => ['shape' => 'TaggingHeader', 'location' => 'header', 'locationName' => 'x-amz-tagging',],
            ],
        ],
        'CopyObjectResult' => [
            'type' => 'structure',
        ...
        'CreateMultipartUploadOutput' => [
            'type' => 'structure',
            'members' => [
                'AbortDate' => ['shape' => 'AbortDate', 'location' => 'header', 'locationName' => 'x-amz-abort-date',],
                'AbortRuleId' => [
                    'shape' => 'AbortRuleId',
                    'location' => 'header',
        ...
        'Delete' => [
            ...
            'required' => ['Objects',],
            'members' => [
                'Objects' => ['shape' => 'ObjectIdentifierList', 'locationName' => 'Object',],
                'Quiet' => ['shape' => 'Quiet',],
            ],
        ],
        ...
        'GetObjectOutput' => [
            ...
            'members' => [
                ...
                'TagCount' => ['shape' => 'TagCount', 'location' => 'header', 'locationName' => 'x-amz-tagging-count',],
            ],
            'payload' => 'Body',
        ],
        'GetObjectRequest' => [
            ...
            'members' => [
                ...
                'IfNoneMatch' => ['shape' => 'IfNoneMatch', 'location' => 'header', 'locationName' => 'If-None-Match',],
                'IfUnmodifiedSince' => [
                ...
                'PartNumber' => ['shape' => 'PartNumber', 'location' => 'querystring', 'locationName' => 'partNumber',],
            ],
        ],
        ...
        'InventoryFormat' => ['type' => 'string', 'enum' => ['CSV',],],
        ...
        'ListMultipartUploadsRequest' => [
            ...
            'members' => [
                'Bucket' => ['shape' => 'BucketName', 'location' => 'uri', 'locationName' => 'Bucket',],
                'Delimiter' => ['shape' => 'Delimiter', 'location' => 'querystring', 'locationName' => 'delimiter',],
                'EncodingType' => [
                    'shape' => 'EncodingType',
                    'location' => 'querystring',
                    'locationName' => 'encoding-type',
                ],
                'KeyMarker' => ['shape' => 'KeyMarker', 'location' => 'querystring', 'locationName' => 'key-marker',],
                'MaxUploads' => [
                    'shape' => 'MaxUploads',
                    'location' => 'querystring',
        ...
        'NotificationConfiguration' => [
            ...
            'members' => [
                ...
                'QueueConfigurations' => ['shape' => 'QueueConfigurationList', 'locationName' => 'QueueConfiguration',],
        ...
        'Payer' => ['type' => 'string', 'enum' => ['Requester', 'BucketOwner',],],
        ...
        'PutBucketAclRequest' => [
            ...
            'required' => ['Bucket',],
            'members' => [
                'ACL' => ['shape' => 'BucketCannedACL', 'location' => 'header', 'locationName' => 'x-amz-acl',],
                'AccessControlPolicy' => [
        ...
        'TargetGrant' => [
            'type' => 'structure',
            'members' => ['Grantee' => ['shape' => 'Grantee',], 'Permission' => ['shape' => 'BucketLogsPermission',],],
        ],
        ...
        'VersioningConfiguration' => [
            'type' => 'structure',
            'members' => [
                'MFADelete' => ['shape' => 'MFADelete', 'locationName' => 'MfaDelete',],
                'Status' => ['shape' => 'BucketVersioningStatus',],
            ],
        ],
        'WebsiteConfiguration' => [
