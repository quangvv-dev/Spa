    ...
    'shapes' => [
        ...
        'ApplySchemaRequest' => [
            ...
            'members' => [
                ...
                'DirectoryArn' => ['shape' => 'Arn', 'location' => 'header', 'locationName' => 'x-amz-data-partition',],
            ],
        ],
        'ApplySchemaResponse' => [
            'type' => 'structure',
        ...
        'Arn' => ['type' => 'string',],
        'Arns' => ['type' => 'list', 'member' => ['shape' => 'Arn',],],
        'AttachObjectRequest' => [
            'type' => 'structure',
        ...
        'BatchDetachObject' => [
            'type' => 'structure',
            'required' => ['ParentReference', 'LinkName', 'BatchReferenceName',],
            'members' => [
                'ParentReference' => ['shape' => 'ObjectReference',],
                'LinkName' => ['shape' => 'LinkName',],
                'BatchReferenceName' => ['shape' => 'BatchReferenceName',],
        ...
        'ConsistencyLevel' => ['type' => 'string', 'enum' => ['SERIALIZABLE', 'EVENTUAL',],],
        'CreateDirectoryRequest' => [
            'type' => 'structure',
            'required' => ['Name', 'SchemaArn',],
            'members' => [
                'Name' => ['shape' => 'DirectoryName',],
                'SchemaArn' => ['shape' => 'Arn', 'location' => 'header', 'locationName' => 'x-amz-data-partition',],
            ],
        ],
        ...
        'CreateFacetResponse' => ['type' => 'structure', 'members' => [],],
        'CreateIndexRequest' => [
            'type' => 'structure',
        ...
        'CreateTypedLinkFacetResponse' => ['type' => 'structure', 'members' => [],],
        'Date' => ['type' => 'timestamp',],
        ...
        'DirectoryList' => ['type' => 'list', 'member' => ['shape' => 'Directory',],],
        ...
        'FacetAttributeUpdate' => [
            'type' => 'structure',
            'members' => ['Attribute' => ['shape' => 'FacetAttribute',], 'Action' => ['shape' => 'UpdateActionType',],],
        ],
        ...
        'ListTypedLinkFacetNamesResponse' => [
            'type' => 'structure',
            'members' => ['FacetNames' => ['shape' => 'TypedLinkNameList',], 'NextToken' => ['shape' => 'NextToken',],],
        ],
        'LookupPolicyRequest' => [
            'type' => 'structure',
            'required' => ['DirectoryArn', 'ObjectReference',],
        ...
        'NumberResults' => ['type' => 'integer', 'min' => 1,],
        ...
        'TagsNumberResults' => ['type' => 'integer', 'min' => 50,],
        'TypedAttributeValue' => [
            'type' => 'structure',
            'members' => [
