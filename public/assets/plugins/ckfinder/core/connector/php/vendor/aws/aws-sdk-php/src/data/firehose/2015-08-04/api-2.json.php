...
return [
    ...
    'shapes' => [
        'AWSKMSKeyARN' => ['type' => 'string', 'max' => 512, 'min' => 1, 'pattern' => 'arn:.*',],
        ...
        'Data' => ['type' => 'blob', 'max' => 1024000, 'min' => 0,],
        ...
        'IntervalInSeconds' => ['type' => 'integer', 'max' => 900, 'min' => 60,],
        ...
        'Password' => ['type' => 'string', 'min' => 6, 'sensitive' => true,],
        'Prefix' => ['type' => 'string',],
        ...
        'ProcessorParameterName' => ['type' => 'string', 'enum' => ['LambdaArn', 'NumberOfRetries',],],
        ...
        'RoleARN' => ['type' => 'string', 'max' => 512, 'min' => 1, 'pattern' => 'arn:.*',],
        ...
        'SizeInMBs' => ['type' => 'integer', 'max' => 128, 'min' => 1,],
