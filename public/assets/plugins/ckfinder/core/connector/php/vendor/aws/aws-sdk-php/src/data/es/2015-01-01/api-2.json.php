...
return [
    ...
    'operations' => [
        'AddTags' => [
            'name' => 'AddTags',
            'http' => ['method' => 'POST', 'requestUri' => '/2015-01-01/tags',],
        ...
        'ListTags' => [
            'name' => 'ListTags',
            'http' => ['method' => 'GET', 'requestUri' => '/2015-01-01/tags/',],
    ...
    'shapes' => [
        ...
        'DomainId' => ['type' => 'string', 'max' => 64, 'min' => 1,],
        ...
        'LimitValueList' => ['type' => 'list', 'member' => ['shape' => 'LimitValue',],],
        'Limits' => [
            'type' => 'structure',
            'members' => [
        ...
        'ListElasticsearchInstanceTypesRequest' => [
            ...
            'members' => [
                ...
                'DomainName' => ['shape' => 'DomainName', 'location' => 'querystring', 'locationName' => 'domainName',],
        ...
        'MaxResults' => ['type' => 'integer', 'max' => 100,],
