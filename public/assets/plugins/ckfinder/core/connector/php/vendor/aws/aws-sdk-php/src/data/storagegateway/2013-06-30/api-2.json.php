...
return [
    ...
    'shapes' => [
        ...
        'BandwidthUploadRateLimit' => ['type' => 'long', 'min' => 51200,],
        ...
        'DayOfWeek' => ['type' => 'integer', 'max' => 6, 'min' => 0,],
        ...
        'DeviceType' => ['type' => 'string', 'max' => 50, 'min' => 2,],
        ...
        'FileShareARN' => ['type' => 'string', 'max' => 500, 'min' => 50,],
        ...
        'FileShareId' => ['type' => 'string', 'max' => 30, 'min' => 12,],
        'FileShareInfo' => [
            'type' => 'structure',
            'members' => [
        ...
        'GatewayId' => ['type' => 'string', 'max' => 30, 'min' => 12,],
        'GatewayInfo' => [
            'type' => 'structure',
            'members' => [
                'GatewayId' => ['shape' => 'GatewayId',],
        ...
        'HourOfDay' => ['type' => 'integer', 'max' => 23, 'min' => 0,],
        'IPV4AddressCIDR' => [
            'type' => 'string',
        ...
        'LocationARN' => ['type' => 'string', 'max' => 310, 'min' => 16,],
        'Marker' => ['type' => 'string', 'max' => 1000, 'min' => 1,],
        'MediumChangerType' => ['type' => 'string', 'max' => 50, 'min' => 2,],
        'MinuteOfHour' => ['type' => 'integer', 'max' => 59, 'min' => 0,],
        ...
        'NumTapesToCreate' => ['type' => 'integer', 'max' => 10, 'min' => 1,],
        'Path' => ['type' => 'string',],
        ...
        'Role' => ['type' => 'string', 'max' => 2048, 'min' => 20,],
        ...
        'StorageClass' => ['type' => 'string', 'max' => 20, 'min' => 5,],
        'StorageGatewayError' => [
            'type' => 'structure',
        ...
        'TapeARNs' => ['type' => 'list', 'member' => ['shape' => 'TapeARN',],],
        'TapeArchive' => [
            'type' => 'structure',
            'members' => [
                'TapeARN' => ['shape' => 'TapeARN',],
        ...
        'TapeDriveType' => ['type' => 'string', 'max' => 50, 'min' => 2,],
        'TapeInfo' => [
            'type' => 'structure',
            'members' => [
                'TapeARN' => ['shape' => 'TapeARN',],
        ...
        'UpdateVTLDeviceTypeInput' => [
            ...
            'members' => ['VTLDeviceARN' => ['shape' => 'VTLDeviceARN',], 'DeviceType' => ['shape' => 'DeviceType',],],
        ],
        ...
        'VolumeId' => ['type' => 'string', 'max' => 30, 'min' => 12,],
        'VolumeInfo' => [
            'type' => 'structure',
            'members' => [
                'VolumeARN' => ['shape' => 'VolumeARN',],
        ...
        'VolumeType' => ['type' => 'string', 'max' => 100, 'min' => 3,],
