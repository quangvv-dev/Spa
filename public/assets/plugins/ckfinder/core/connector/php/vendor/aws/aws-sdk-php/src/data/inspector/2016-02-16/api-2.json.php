...
return [
    ...
    'shapes' => [
        ...
        'AgentHealth' => ['type' => 'string', 'enum' => ['HEALTHY', 'UNHEALTHY',],],
        'AgentHealthCode' => [
            'type' => 'string',
        ...
        'AmiId' => ['type' => 'string', 'max' => 256, 'min' => 0,],
        'Arn' => ['type' => 'string', 'max' => 300, 'min' => 1,],
        ...
        'AssessmentRunDuration' => ['type' => 'integer', 'max' => 86400, 'min' => 180,],
        'AssessmentRunFilter' => [
            'type' => 'structure',
            'members' => [
        ...
        'AssessmentTargetName' => ['type' => 'string', 'max' => 140, 'min' => 1,],
        'AssessmentTemplate' => [
            'type' => 'structure',
            'required' => [
                'arn',
        ...
        'AssessmentTemplateName' => ['type' => 'string', 'max' => 140, 'min' => 1,],
        ...
        'Hostname' => ['type' => 'string', 'max' => 256, 'min' => 0,],
        'InspectorEvent' => [
            'type' => 'string',
            'enum' => [
        ...
        'IocConfidence' => ['type' => 'integer', 'max' => 10, 'min' => 0,],
        ...
        'NumericSeverity' => ['type' => 'double', 'max' => 10, 'min' => 0,],
        ...
        'Text' => ['type' => 'string', 'max' => 20000, 'min' => 0,],
