...
return [
    ...
    'operations' => [
        'BatchGetTraces' => [
            'name' => 'BatchGetTraces',
            'http' => ['method' => 'POST', 'requestUri' => '/Traces',],
        ...
        'GetServiceGraph' => [
            ...
            'http' => ['method' => 'POST', 'requestUri' => '/ServiceGraph',],
        ...
        'GetTraceGraph' => [
            'name' => 'GetTraceGraph',
            'http' => ['method' => 'POST', 'requestUri' => '/TraceGraph',],
    ...
    'shapes' => [
        ...
        'AliasNames' => ['type' => 'list', 'member' => ['shape' => 'String',],],
        ...
        'EdgeList' => ['type' => 'list', 'member' => ['shape' => 'Edge',],],
        'EdgeStatistics' => [
            'type' => 'structure',
            'members' => [
        ...
        'FaultStatistics' => [
            'type' => 'structure',
            'members' => ['OtherCount' => ['shape' => 'NullableLong',], 'TotalCount' => ['shape' => 'NullableLong',],],
        ],
        'FilterExpression' => ['type' => 'string', 'max' => 2000, 'min' => 0,],
        ...
        'SegmentDocument' => ['type' => 'string', 'min' => 1,],
        'SegmentId' => ['type' => 'string', 'max' => 16, 'min' => 16,],
        'SegmentList' => ['type' => 'list', 'member' => ['shape' => 'Segment',],],
        'Service' => [
            'type' => 'structure',
            'members' => [
                'ReferenceId' => ['shape' => 'NullableInteger',],
        ...
        'TraceId' => ['type' => 'string', 'max' => 35, 'min' => 35,],
