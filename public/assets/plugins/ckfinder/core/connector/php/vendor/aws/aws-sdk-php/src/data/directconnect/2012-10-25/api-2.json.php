...
return [
    ...
    'shapes' => [
        'ASN' => ['type' => 'integer',],
        'AddressFamily' => ['type' => 'string', 'enum' => ['ipv4', 'ipv6',],],
        ...
        'BGPPeerState' => [
            'type' => 'string',
            'enum' => ['verifying', 'pending', 'available', 'deleting', 'deleted',],
        ],
        'BGPStatus' => ['type' => 'string', 'enum' => ['up', 'down',],],
        ...
        'LagId' => ['type' => 'string',],
        'LagList' => ['type' => 'list', 'member' => ['shape' => 'Lag',],],
        'LagName' => ['type' => 'string',],
        'LagState' => [
            'type' => 'string',
            'enum' => ['requested', 'pending', 'available', 'down', 'deleting', 'deleted',],
