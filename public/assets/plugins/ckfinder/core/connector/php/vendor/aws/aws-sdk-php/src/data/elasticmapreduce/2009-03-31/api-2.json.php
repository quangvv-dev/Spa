...
return [
    ...
    'shapes' => [
        ...
        'CancelStepsInput' => [
            'type' => 'structure',
            'members' => ['ClusterId' => ['shape' => 'XmlStringMaxLen256',], 'StepIds' => ['shape' => 'StepIdsList',],],
        ],
        'CancelStepsOutput' => [
            'type' => 'structure',
        ...
        'ClusterStateChangeReason' => [
            'type' => 'structure',
            'members' => ['Code' => ['shape' => 'ClusterStateChangeReasonCode',], 'Message' => ['shape' => 'String',],],
        ],
        ...
        'Marker' => ['type' => 'string',],
        'MarketType' => ['type' => 'string', 'enum' => ['ON_DEMAND', 'SPOT',],],
        'MetricDimension' => [
            'type' => 'structure',
        ...
        'NonNegativeDouble' => ['type' => 'double', 'min' => 0,],
        'PlacementType' => [
            'type' => 'structure',
            'members' => [
