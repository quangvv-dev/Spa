...
return [
    ...
    'shapes' => [
        'ActionsList' => ['type' => 'list', 'member' => ['shape' => 'action',],],
        'AddPermissionInput' => [
            'type' => 'structure',
        ...
        'Endpoint' => [
            'type' => 'structure',
            'members' => ['EndpointArn' => ['shape' => 'String',], 'Attributes' => ['shape' => 'MapStringToString',],],
        ],
        ...
        'ListPhoneNumbersOptedOutInput' => [
            'type' => 'structure',
            'members' => ['nextToken' => ['shape' => 'string',],],
        ],
        ...
        'OptInPhoneNumberResponse' => ['type' => 'structure', 'members' => [],],
        ...
        'SubscriptionsList' => ['type' => 'list', 'member' => ['shape' => 'Subscription',],],
        'ThrottledException' => [
            'type' => 'structure',
            'members' => ['message' => ['shape' => 'string',],],
            'error' => ['code' => 'Throttled', 'httpStatusCode' => 429, 'senderFault' => true,],
            'exception' => true,
        ],
        ...
        'TopicsList' => ['type' => 'list', 'member' => ['shape' => 'Topic',],],
        'UnsubscribeInput' => [
            'type' => 'structure',
            'required' => ['SubscriptionArn',],
            'members' => ['SubscriptionArn' => ['shape' => 'subscriptionARN',],],
