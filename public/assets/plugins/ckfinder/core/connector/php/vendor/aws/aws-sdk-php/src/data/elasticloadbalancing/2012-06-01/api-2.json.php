...
return [
    ...
    'shapes' => [
        ...
        'AddTagsInput' => [
            ...
            'members' => ['LoadBalancerNames' => ['shape' => 'LoadBalancerNames',], 'Tags' => ['shape' => 'TagList',],],
        ],
        ...
        'AttachLoadBalancerToSubnetsInput' => [
            ...
            'members' => ['LoadBalancerName' => ['shape' => 'AccessPointName',], 'Subnets' => ['shape' => 'Subnets',],],
        ],
        ...
        'DeregisterEndPointsOutput' => [
            'type' => 'structure',
            'members' => ['Instances' => ['shape' => 'Instances',],],
        ],
        ...
        'InstancePort' => ['type' => 'integer', 'max' => 65535, 'min' => 1,],
        'InstanceState' => [
            'type' => 'structure',
            'members' => [
        ...
        'Ports' => ['type' => 'list', 'member' => ['shape' => 'AccessPointPort',],],
        ...
        'UnhealthyThreshold' => ['type' => 'integer', 'max' => 10, 'min' => 2,],
