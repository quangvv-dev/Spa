...
//                        $date = Carbon::createFromFormat('d/m/Y', trim($row['ngay_tao_kh']))->format('Y-m-d');
    ...
    public function actionJobChangeStatus($rule,$config,$customer)
    {
...
//                                $title = $task->type == NotificationConstant::CALL ? '💬💬💬 Bạn có công việc gọi điện mới !' : '📅📅📅 Bạn có công việc chăm sóc mới !';
//                                Notification::insert([
//                                    'title' => $title,
