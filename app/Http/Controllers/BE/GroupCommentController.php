...
class GroupCommentController extends Controller
{
    ...
    public function index2(Request $request, $id)
    {
        ...
        $groupComments = DB::table('group_comments')->join('users as u', 'u.id', '=', 'group_comments.user_id')
            ...
            ->select('u.full_name','u.avatar','group_comments.id','group_comments.created_at','group_comments.messages','group_comments.image','group_comments.user_id','group_comments.call_id')
            ->orderBy('id', 'desc')
            ->get();
