...
class OrderController extends Controller
{
    ...
    public function __construct(OrderService $orderService, OrderDetailService $orderDetailService, TaskService $taskService)
    {
        ...
        view()->share([
            ...
            'customer_y_ta' => User::select('id', 'avatar', 'full_name', 'percent_rose')
                ->whereIn('department_id', [DepartmentConstant::TECHNICIANS, DepartmentConstant::TU_VAN_VIEN])->get(),
        ]);
    }
