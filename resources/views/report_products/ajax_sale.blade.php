...
<div style="width: 100%; overflow: auto;margin-top: 20px;height: 900px;" class="tableFixHead">
    <table class="table table-bordered table-info hidden-xs" style="margin-bottom: 0px;">
        ...
        <tr class="tr1" style="text-transform:unset">
            ...
            {{--<th class="text-center">Khách hàng đến</th>--}}
        ...
        @if(count($users))
            @foreach($users as $item)
                ...
                $schedules_percent += $item->schedules_den >0 && $item->customer_new>0 ?round(($item->schedules_den/$item->customer_new)*100):0;
        ...
        <tr>
            ...
            <td class="text-center bold">{{!empty($payment_new)&& !empty($order_new)?number_format($payment_new/$order_new):0}}</td>
