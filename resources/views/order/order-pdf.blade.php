    ...
    <div class="row">
        <div class="col-xs-12">
            <table class="table mt0">
                ...
                <tr>
                    <td colspan="2" class="text-center">
                        <h3>{{!empty(setting('title_website'))?setting('title_website'):'VIỆN THẨM MỸ ROYAL'}}</h3><br>
                    </td>
                </tr>
                <tr>
            ...
            <table class="table table-bordered mt10">
                ...
                <tr>
                    <td class="font12"
                        colspan="3">{{$payment->payment_type==1?'Tiền mặt':($payment->payment_type==2?'Thẻ':'Điểm')}}</td>
                ...
                <tr>
                    <td colspan="4">
                        @if(!empty(setting('title_website')))
                            ...
                            <div
                                class="text-center font12">{{!empty(setting('bottom_pdf')) ? setting('bottom_pdf'):''}}</div>
                        @else
                            <div class="text-center"><b>CÁM ƠN QUÝ KHÁCH VÀ HẸN GẶP LẠI</b></div>
