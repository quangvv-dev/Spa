...
@section('content')
    <div class="col-md-12 col-lg-12">
        <div class="card">
            ...
            @if (isset($doc))
                {!! Form::model($doc, array('url' => url('category-product/'.$doc->id), 'method' => 'put', 'files'=> true,'id'=>'fvalidate')) !!}
            @else
                {!! Form::open(array('url' => route('category-product.store'), 'method' => 'post', 'files'=> true,'id'=>'fvalidate')) !!}
            @endif
            <div class="col row">
            ...
            <div class="col bot">
                ...
                <a href="{{route('category-product.index')}}" class="btn btn-danger">Về danh sách</a>
            </div>
            {{ Form::close() }}
