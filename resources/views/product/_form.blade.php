...
@section('content')
    ...
    <div class="col-md-12 col-lg-12">
        <div class="card">
            ...
            @if (isset($doc))
                {!! Form::model($doc, array('url' => url('products/'.$doc->id), 'method' => 'put', 'files'=> true,'id'=>'fvalidate')) !!}
            @else
                {!! Form::open(array('url' => route('products.store'), 'method' => 'post', 'files'=> true,'id'=>'fvalidate')) !!}
            @endif
            <div class="col row">
