                        ...
                        @if(count($marketing))
                            @foreach($marketing as $key =>$item)
                                ...
                                @if ($key >10)
                                    @break
                                @endif
                                <div class="item-rank {{count($my_key) && $my_key[0]<9 && $my_key[0]==$key-1?'my-rank':''}} {{$key==1?'item-rank1':'item-rank'.($key)}}">
                                    <div class="king-sale">
                                        <img src="{{asset('images/bxh2.png')}}">
                                    </div>
                                    <div
                                        class="avatar-container {{$key == 1?'blink1':'blink'.($key)}}">
                                        <img class="avatar-img" src="{{$item->avatar ? $item->avatar : asset('assets/images/brand/logo.png')}}">
                                    </div>
                                    <div class="item-info">
                                        <div
                            ...
                            {{--@if(count($my_key) && $my_key[0]>9)--}}
                                {{--<div class="item-rank my-rank item-rank11">--}}
                                    ...
                                    {{--<div--}}
                                        ...
                                        {{--<img class="avatar-img" src="{{$response[$my_key[0]]['avatar'] ? $response[$my_key[0]]['avatar'] : asset('/default/logo.png')}}">--}}

                                    {{--</div>--}}
                                    {{--<div class="item-info">--}}
                                        {{--<div class="item-stt">{{$my_key[0]}}</div>--}}
                                        {{--<div class="item-tennv">{{@$response[$my_key[0]]['name']}}</div>--}}
                                        {{--<div class="item-ds">--}}
