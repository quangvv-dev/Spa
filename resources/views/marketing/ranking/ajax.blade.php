                        ...
                        <div class="box">
                            ...
                            <div class="body position-relative">
                                <div class="p-16">
                                    ...
                                    <div class="fs-24" style="margin-top: 34px; line-height: 25.2px;">{{str_limit($marketing[0]['full_name'],15)}}</div>
                                    <div class="fs-14 color-dark mt-8">{{@$marketing[0]['branch_name']??'Tất cả chi nhánh'}}</div>
                                    <div class="d-flex justify-content-between align-items-center mt-16">

                                        <div class="text-center">
                                            <div class="color-info" style="font-size: 22px;">{{number_format($marketing[0]['gross_revenue'])}}</div>
                                        ...
                                        <div class="text-center">
                                            <div class="color-info" style="font-size: 22px;">{{number_format((int)$marketing[0]['orders'])}}</div>
                    ...
                    @if(@$marketing[1])
                        <div class="box">
                            <div class="header1 position-relative">
                                ...
                                <img src="{{asset('layout/images/Polygon.png')}}" alt="" class="header1_bg">
                                <img src="{{$marketing[1]['avatar']??asset('layout/images/Ava1.png')}}" alt="Avatar" class="header1_ava">
                            </div>
                            <div class="body position-relative">
                                <div class="p-16">
                                    <div class="fs-24" style="margin-top: 34px; line-height: 25.2px;">{{$marketing[1]['full_name']}}</div>
                                    <div class="fs-14 color-dark mt-8">{{@$marketing[1]['branch_name']??'Tất cả chi nhánh'}}</div>
                                    <div class="d-flex justify-content-between align-items-center mt-16">

                                        <div class="text-center">
                                            <div class="color-info" style="font-size: 22px;">{{number_format($marketing[1]['gross_revenue'])}}</div>
                                            <div class="color-dark fs-14 mt-8">Doanh số</div>
                                        </div>
                                        <div class="">
                                            <img src="{{asset('layout/images/Line.png')}}" alt="" style="height: 26px;">
                                        ...
                                        <div class="text-center">
                                            <div class="color-info" style="font-size: 22px;">{{number_format((int)$marketing[1]['orders'])}}</div>
                                            <div class="color-dark fs-14 mt-8">Đơn hàng</div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    @if(@$marketing[2])
                        <div class="box">
                            <div class="header1 position-relative">
                                ...
                                <img src="{{$marketing[2]['avatar']??asset('layout/images/Ava1.png')}}" alt="Avatar" class="header1_ava">
                            </div>
                            <div class="body position-relative">
                                <div class="p-16">
                                    <div class="fs-24" style="margin-top: 34px; line-height: 25.2px;">{{str_limit($marketing[2]['full_name'],15)}}</div>
                                    <div class="fs-14 color-dark mt-8">{{@$marketing[2]['branch_name']??'Tất cả chi nhánh'}}</div>
                                    <div class="d-flex justify-content-between align-items-center mt-16">

                                        <div class="text-center">
                                            <div class="color-info" style="font-size: 22px;">{{number_format($marketing[2]['gross_revenue'])}}</div>
                                            <div class="color-dark fs-14 mt-8">Doanh số</div>
                                        </div>
                                        <div class="">
                                            <img src="{{asset('layout/images/Line.png')}}" alt="" style="height: 26px;">
                                        ...
                                        <div class="text-center">
                                            <div class="color-info" style="font-size: 22px;">{{number_format((int)$marketing[2]['orders'])}}</div>
                                            <div class="color-dark fs-14 mt-8">Đơn hàng</div>
                                        </div>
                                    </div>
                                </div>
