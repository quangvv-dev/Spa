<div class="modal fade text-left" id="modalFanpagePost" tabindex="-1" role="dialog" aria-labelledby="modalFanpagePost"
     style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-main">
                <h5 class="modal-title" id="myModalLabel"> Nhập bài viết quảng cáo (thủ công)</h5>
