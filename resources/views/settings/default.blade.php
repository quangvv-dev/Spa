        ...
        <div class="col row">
            ...
            <div class="col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    {!! Form::select('server_call_center',[\App\Constants\StatusCode::SERVER_3CX=>'Sever 3CX',\App\Constants\StatusCode::SERVER_CGV_TELECOM=>'Server CgvTelecom',\App\Constants\StatusCode::SERVER_GTC_TELECOM=>'Server GtcTelecom' ], @setting('server_call_center'), array('class' => 'form-control','data-placeholder'=>'Danh mục cha')) !!}
                </div>
