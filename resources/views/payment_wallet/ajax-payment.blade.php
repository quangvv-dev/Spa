        ...
        @if (count($datas))
            @foreach($datas as $key => $data)
                <tr>
                    ...
                    <td class="text-center">{{isset($data->order_wallet) ? ($data->order_wallet->order_price - $data->order_wallet->price)>0? @number_format($data->order_wallet->order_price - $data->order_wallet->price) :0:0}}
