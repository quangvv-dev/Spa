                ...
                <div class="content__left w-232">
                    ...
                    <div class="border padding mt10 ml2">
                        <div class="infor-top-ct">
                            ...
                            <div class="mb10 clearfix fs-14"><p class="bold pr5 fl fs-16">Người phụ trách:</p>
                                <p class="word-wrap"> &nbsp;{{ @$customer->telesale->full_name }}</p>
                            </div>
                            <div class="mb10 clearfix fs-14"><p class="bold pr5 fl fs-16">CSKH:</p>
                                <p class="word-wrap"> &nbsp;{{ @$customer->cskh->full_name }}</p>
                            </div>
                            <div class="mb10 clearfix fs-14"><p class="bold pr5 fl fs-16">Liên hệ cuối:</p>
                                <p class="word-wrap text-danger"> &nbsp;{{ @diffTime($customer->last_time) }}</p>
                            </div>
                            <div class="mb10 clearfix fs-14"><p class="bold pr5 fl fs-16">Nhóm giới tính:</p>
                                <p class="word-wrap"> &nbsp;{{ @$customer->genitive->name }}</p>
                            </div>
                            <div class="mb10 clearfix fs-14"><p class="bold pr5 fl fs-16">Nguồn KH:</p>
                                <p class="word-wrap"> &nbsp;{{ @$customer->source_customer->name }}</p>
                            </div>
                            <div class="mb10 clearfix fs-14"><p class="bold pr5 fl fs-16">Sinh nhật:</p>
                                <p class="word-wrap"> &nbsp;{{ $customer->birthday }}</p>
                            </div>
                            <div class="mb10 clearfix fs-14"><p class="bold pr5 fl fs-16">Mối quan hệ:</p>
                                <p class="word-wrap"> &nbsp;{{ @$customer->status->name }}</p>
                            </div>
                            <div class="mb10 clearfix fs-14"><p class="bold pr5 fl fs-16">Ngày tạo:</p>
                                <p class="word-wrap"> &nbsp;{{ $customer->created_at }}</p>
                            </div>
                            <div class="mb10 clearfix fs-14"><p class="bold pr5 fl fs-16">Giới tính:</p>
                                <p class="word-wrap"> &nbsp;{{ $customer->genderText }}</p>
                            </div>
                            <div class="mb10 clearfix fs-14"><p class="bold pr5 fl fs-16">Mô tả:</p>
                                <p class="word-wrap"> &nbsp;{{ $customer->description }}</p>
                            </div>
                            <div class="mb10 clearfix fs-14"><p class="bold pr5 fl fs-16">Số đơn hàng:</p>
                                <p class="word-wrap "> &nbsp;{{ $customer->orders->count() }}</p>
                            </div>
                            <div class="mb10 clearfix fs-14"><p class="bold pr5 fl fs-16">Tổng doanh thu:</p>
                                <p class="word-wrap">
                                    &nbsp;{{number_format($customer->orders->sum('gross_revenue'))}}</p>
                            </div>
                            <div class="mb10 clearfix fs-14"><p class="bold pr5 fl fs-16">Tổng số tương tác:</p>
                                <p class="word-wrap">&nbsp;0</p>
                            </div>
                            <div class="mb10 clearfix fs-14"><p class="bold pr5 fl fs-16">Giá trị:</p>
                                <p class="word-wrap">
                                    &nbsp;{{number_format($customer->orders->sum('gross_revenue'))}}</p>
                            </div>
                        </div>
