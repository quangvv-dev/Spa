<div class="modal fade modal-custom" id="updateRelation" role="dialog"  aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
                ...
                <div class="col row">
                    <div class="col-xs-12 col-md-12">
                        <div class="form-group required {{ $errors->has('user_id') ? 'has-error' : '' }}">
                            ...
                            {!! Form::select('branch_id', $status, null, array('class' => 'form-control select2 branch-customer', 'required' => 'required')) !!}
                        </div>
                    </div>
                </div>
                {{ Form::close() }}
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary update-multiple-status">Lưu</button>
            </div>
        </div>
    </div>
</div>
