...
@section('_script')
    <script type="text/javascript">
        $(function () {
            ...
            @if(\Illuminate\Support\Facades\Auth::user()->role!=\App\Constants\UserConstant::TELESALES|| \Illuminate\Support\Facades\Auth::user()->phone=='0972430896'||\Illuminate\Support\Facades\Auth::user()->phone=='0776904396')
